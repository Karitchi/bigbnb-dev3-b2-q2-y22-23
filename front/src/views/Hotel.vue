...
import Images from '@/components/Hotel/Images.vue';
import Informations from '@/components/Hotel/Informations.vue';
...
<template>
    <div class="container ps-5 pe-5">
        ...
        <ReviewForm class="pb-5 pt-5" />
        <ReviewsList class="row pb-5 pt-5" />
    </div>
</template>
